	...
	table.insert(ProceduralDistributions["list"]["BedroomDresser"].junk.items, 2);

	table.insert(ProceduralDistributions["list"]["BedroomSideTable"].junk.items, "Tsarcraft.TCBoombox");
	table.insert(ProceduralDistributions["list"]["BedroomSideTable"].junk.items, 2);
	...
	table.insert(ProceduralDistributions["list"]["MusicStoreOthers"].items, 4);
	
	table.insert(ProceduralDistributions["list"]["MusicStoreCDs"].items, "Tsarcraft.TCBoombox");
	table.insert(ProceduralDistributions["list"]["MusicStoreCDs"].items, 1);
	...
	table.insert(ProceduralDistributions["list"]["ClassroomDesk"].junk.items, 2);
	...
	table.insert(ProceduralDistributions["list"]["ElectronicStoreMusic"].items, 4);
	
	table.insert(ProceduralDistributions["list"]["DaycareShelves"].junk.items, "Tsarcraft.TCBoombox");
	table.insert(ProceduralDistributions["list"]["DaycareShelves"].junk.items, 1);
	
	table.insert(ProceduralDistributions["list"]["DeskGeneric"].junk.items, "Tsarcraft.TCBoombox");
	table.insert(ProceduralDistributions["list"]["DeskGeneric"].junk.items, 2);
	...
	table.insert(ProceduralDistributions["list"]["GigamartHouseElectronics"].items, 4);
	
	table.insert(ProceduralDistributions["list"]["KitchenBook"].items, "Tsarcraft.TCBoombox");
	table.insert(ProceduralDistributions["list"]["KitchenBook"].items, 0.2);
	...
	table.insert(ProceduralDistributions["list"]["LibraryCounter"].junk.items, 2);
	
	table.insert(ProceduralDistributions["list"]["OfficeDesk"].junk.items, "Tsarcraft.TCBoombox");
	table.insert(ProceduralDistributions["list"]["OfficeDesk"].junk.items, 2);
	
	table.insert(ProceduralDistributions["list"]["OfficeDeskHome"].junk.items, "Tsarcraft.TCBoombox");
	table.insert(ProceduralDistributions["list"]["OfficeDeskHome"].junk.items, 2);
	
	table.insert(ProceduralDistributions["list"]["PoliceDesk"].junk.items, "Tsarcraft.TCBoombox");
	table.insert(ProceduralDistributions["list"]["PoliceDesk"].junk.items, 2);
	...
	table.insert(ProceduralDistributions["list"]["WardrobeMan"].junk.items, "Tsarcraft.TCBoombox");
	table.insert(ProceduralDistributions["list"]["WardrobeMan"].junk.items, 2);
	
	table.insert(ProceduralDistributions["list"]["WardrobeManClassy"].junk.items, "Tsarcraft.TCBoombox");
	table.insert(ProceduralDistributions["list"]["WardrobeManClassy"].junk.items, 2);
	...
	table.insert(ProceduralDistributions["list"]["WardrobeWoman"].junk.items, "Tsarcraft.TCBoombox");
	table.insert(ProceduralDistributions["list"]["WardrobeWoman"].junk.items, 1);
	
	table.insert(ProceduralDistributions["list"]["WardrobeWomanClassy"].junk.items, "Tsarcraft.TCBoombox");
	table.insert(ProceduralDistributions["list"]["WardrobeWomanClassy"].junk.items, 1);
	...
	table.insert(ProceduralDistributions["list"]["MusicStoreCases"].items, 0.4);
	...
	table.insert(ProceduralDistributions["list"]["StoreCounterCleaning"].items, "Tsarcraft.TCBoombox");
	table.insert(ProceduralDistributions["list"]["StoreCounterCleaning"].junk.items, 1);
	...
	table.insert(ProceduralDistributions["list"]["MusicStoreCases"].items, 4);
	...
	table.insert(ProceduralDistributions["list"]["CrateCompactDiscs"].items, 4);
	...
	table.insert(ProceduralDistributions["list"]["MusicStoreCDs"].items, 4);
	
	table.insert(ProceduralDistributions["list"]["MusicStoreSpeaker"].items, "Tsarcraft.TCVinylplayer");
	table.insert(ProceduralDistributions["list"]["MusicStoreSpeaker"].items, 4);
